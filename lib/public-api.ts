...
const CASE_COLUMNS =
  'id, title, date, clinical_domain, clinical_domains, specialty_tags, interview_themes, notes, pinned, importance, is_demo, deleted_at, created_at, updated_at'

const PORTFOLIO_COLUMNS =
  'id, category, title, date, specialty_tags, interview_themes, notes, pinned, importance, is_demo, '
