...
export function MockShareLink({ className = '' }: { className?: string }) {
  return (
    <WindowChrome
      ...
      label="Illustrative Clerkfolio screen for creating and managing PIN-protected portfolio share links"
      className={className}
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
        <div className="rounded-xl border border-default bg-[var(--bg-canvas)] p-4">
          ...
          <div className="space-y-3 text-xs">
            ...
            <span className="block w-full rounded-lg bg-[var(--button-primary-bg)] px-3 py-2.5 text-center text-xs font-semibold text-[var(--button-primary-text)]">Create link</span>
          </div>
        </div>
        <div className="rounded-xl border border-default bg-[var(--bg-canvas)] p-4">
  ...
  return (
    <div className="rounded-lg border border-default bg-[var(--bg-surface)] p-3">
      ...
      <div className="mt-2 flex gap-1.5">
        <span className="rounded border border-default px-2 py-1 text-[10px] text-ink-soft">Copy</span>
        <span className="rounded border border-default px-2 py-1 text-[10px] text-ink-soft">Renew</span>
        <span className="rounded border border-red-500/30 px-2 py-1 text-[10px] text-[var(--danger)]">Revoke</span>
      </div>
    </div>
  )
}
