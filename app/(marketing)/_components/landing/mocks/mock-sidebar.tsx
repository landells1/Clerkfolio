...
export function MockSidebar({ active }: { active: string }) {
  return (
    <aside className="flex w-[168px] shrink-0 flex-col border-r border-default bg-[var(--bg-canvas)] px-2 py-3.5 max-sm:hidden">
          ...
          return (
            <div
              ...
              className={`flex items-center gap-2 rounded-md border px-2 py-2 text-[12px] ${
                isActive
                  ? 'border-default bg-[var(--bg-surface)] text-ink'
