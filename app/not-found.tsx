...
export const metadata: Metadata = {
  title: '404 - Page not found · Clerkfolio',
}
...
export default function NotFound() {
  return (
    <div style={{ background: 'var(--bg-canvas)', color: 'var(--text-primary)', minHeight: '100vh', fontFamily: '"Inter", -apple-system, system-ui, sans-serif', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '40px 24px' }}>
      <div style={{ fontFamily: 'monospace', fontSize: 11, color: 'var(--text-secondary)', letterSpacing: 1.5, marginBottom: 24 }}>404 · NOT FOUND</div>
      <h1 style={{ fontSize: 'clamp(48px, 8vw, 96px)', fontWeight: 500, letterSpacing: -3, margin: 0, marginBottom: 20, lineHeight: 1 }}>
        Lost in the{' '}
        <span style={{ background: 'var(--accent-gradient)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text', fontStyle: 'italic', fontWeight: 400 }}>
          index.
        </span>
      </h1>
      <p style={{ fontSize: 18, color: 'var(--text-secondary)', maxWidth: 480, textAlign: 'center', lineHeight: 1.6, marginBottom: 40 }}>
