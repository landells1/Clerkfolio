  ...
  return (
    <div className="bg-[var(--bg-surface)] border border-white/[0.08] rounded-2xl p-8">
      ...
      {nextPath.startsWith('/upgrade') && (
        <div className="bg-accent/10 border border-accent/20 rounded-lg px-3.5 py-2.5 text-sm text-[var(--accent-soft-text)] mb-4">
      ...
      <p className="text-center text-sm text-[var(--text-secondary)] mt-6">
        ...
        <Link href={nextPath.startsWith('/upgrade') ? `/signup?next=${encodeURIComponent(nextPath)}` : '/signup'} className="text-[var(--accent-text)] hover:text-accent/80 transition-colors font-medium">
          Sign up free
        </Link>
      </p>
    </div>
