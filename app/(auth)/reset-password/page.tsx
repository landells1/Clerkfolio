  ...
  if (sent) {
    return (
      <div className="bg-[var(--bg-surface)] border border-white/[0.08] rounded-2xl p-8 text-center">
        ...
        <Link href="/login" className="text-sm text-[var(--accent-text)] hover:text-accent/80 transition-colors">
          ← Back to login
        </Link>
      </div>
    )
  ...
  return (
    <div className="bg-[var(--bg-surface)] border border-white/[0.08] rounded-2xl p-8">
      ...
      <p className="text-center text-sm text-[var(--text-secondary)] mt-6">
        <Link href="/login" className="text-[var(--accent-text)] hover:text-accent/80 transition-colors">
          ← Back to login
        </Link>
      </p>
    </div>
