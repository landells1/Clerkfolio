...
export default async function PortfolioDiffPage({
  params,
  searchParams,
}: {
  ...
  return (
    <div className="max-w-5xl p-6 lg:p-8">
      <Link href={`/portfolio/${id}/history`} className="text-sm text-[rgba(245,245,242,0.55)] hover:text-[#F5F5F2]">Back to history</Link>
