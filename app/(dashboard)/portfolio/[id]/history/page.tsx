...
export default async function PortfolioHistoryPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="p-6 lg:p-8 max-w-3xl">
      <Link href={`/portfolio/${params.id}`} className="text-sm text-[rgba(245,245,242,0.45)] hover:text-[#F5F5F2]">Back to entry</Link>
