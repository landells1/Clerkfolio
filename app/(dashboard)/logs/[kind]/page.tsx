    ...
    <PullToRefresh className="max-w-container mx-auto p-6 lg:p-8">
      ...
      {rotationReflectionPrompts.length > 0 && (
        <div className="mb-6 rounded-lg border border-pill-blue bg-pill-blue p-4">
          ...
          <Link href="/portfolio/new?category=reflection" className="mt-3 inline-flex min-h-[40px] items-center rounded-lg bg-blue-500 hover:bg-blue-600 px-4 text-sm font-semibold text-surface-0 transition-colors">
            Add reflection
          </Link>
        </div>
      )}
