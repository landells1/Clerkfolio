...
export default function DashboardError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-4 text-center">
      <p className="text-xs font-mono text-[rgba(245,245,242,0.55)] tracking-widest mb-6">§ ERROR</p>
      ...
      <div className="flex gap-3">
        ...
        <Link
          href="/dashboard"
          className="border border-[rgba(245,245,242,0.12)] text-[rgba(245,245,242,0.7)] px-5 py-2.5 rounded-lg text-sm font-medium hover:border-[rgba(245,245,242,0.55)] transition-colors"
        >
          Back to dashboard
        </Link>
      </div>
