      ...
      <body style={{ margin: 0, background: '#0B0B0C', color: '#F5F5F2', fontFamily: '"Inter", -apple-system, system-ui, sans-serif' }}>
        <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '40px 24px' }}>
          ...
          <p style={{ fontSize: 16, color: 'rgba(245,245,242,0.55)', maxWidth: 400, textAlign: 'center', lineHeight: 1.6, marginBottom: 40 }}>
            ...
            <a href="mailto:hello@clinidex.co.uk" style={{ color: '#1D9E75' }}>hello@clinidex.co.uk</a>{' '}
          ...
          <button
            onClick={reset}
            style={{ background: '#1D9E75', color: '#0B0B0C', padding: '12px 28px', borderRadius: 8, border: 'none', fontSize: 14, fontWeight: 600, cursor: 'pointer' }}
          >
            Try again
          </button>
        </div>
