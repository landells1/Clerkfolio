            ...
            {editingId === row.id && editDraft ? (
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  <button type="button" disabled={saving} onClick={() => void saveLog(row.id)} className="min-h-[40px] rounded-lg bg-[var(--button-primary-bg)] px-4 text-sm font-semibold text-[var(--button-primary-text)] disabled:opacity-50">
