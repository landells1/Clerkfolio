...
export default function DuplicateEntryButton({ entryId }: { entryId: string }) {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="flex items-center gap-2 px-3.5 py-2 text-sm font-medium text-[var(--text-secondary)] border border-white/[0.08] rounded-lg hover:text-[var(--text-primary)] hover:border-white/[0.15] transition-colors disabled:opacity-50"
    >
