        ...
        {sorted.length >= 3 && (
          <div className="flex items-center gap-1 shrink-0 ml-2">
            <button
              ...
              title="Bar view"
              className={`p-1.5 rounded-lg transition-colors ${view === 'bar' ? 'bg-[#1B6FD9]/20 text-[var(--accent-text)]' : 'text-[var(--text-secondary)] hover:text-[var(--text-secondary)]'}`}
            >
            ...
            <button
              ...
              title="Radar view"
              className={`p-1.5 rounded-lg transition-colors ${view === 'radar' ? 'bg-[#1B6FD9]/20 text-[var(--accent-text)]' : 'text-[var(--text-secondary)] hover:text-[var(--text-secondary)]'}`}
            >
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
