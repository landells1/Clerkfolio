            ...
            <div className="shrink-0 flex items-center gap-2">
              ...
              {item.type === 'Deadline' && (
                <button
                  ...
                  className="flex h-7 w-7 items-center justify-center rounded-full border border-white/[0.08] text-[var(--text-muted)] hover:border-[var(--accent)] hover:text-[var(--accent-text)] disabled:opacity-50"
                >
