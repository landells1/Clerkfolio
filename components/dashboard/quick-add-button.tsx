  ...
  return (
    <div className="relative inline-flex">
      <button
        ...
        className="flex shrink-0 items-center gap-2 rounded-xl bg-[var(--button-primary-bg)] px-4 py-2.5 text-sm font-semibold text-[var(--button-primary-text)] transition-colors hover:bg-[var(--button-primary-bg-hover)]"
      >
