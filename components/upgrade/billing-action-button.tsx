  ...
  return (
    <div className="space-y-2">
      <button
        ...
        onClick={openBilling}
        disabled={loading}
        className="min-h-[44px] w-full rounded-lg bg-[var(--accent)] px-5 py-2.5 text-sm font-semibold text-white hover:bg-[var(--accent-hover)] disabled:opacity-50 sm:w-auto"
      >
