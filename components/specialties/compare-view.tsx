      ...
      <div className="bg-[var(--bg-surface)] border border-white/[0.08] rounded-2xl overflow-hidden">
        ...
        {allDomainKeys.map((domainKey, idx) => {
          ...
          return (
            ...
            >
              <div className={`p-3.5 flex items-center justify-center ${leftHigher ? 'bg-accent/[0.08]' : ''}`}>
              ...
              <div className={`p-3.5 flex items-center justify-center ${rightHigher ? 'bg-accent/[0.08]' : ''}`}>
