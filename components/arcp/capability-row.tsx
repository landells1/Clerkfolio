      ...
      >
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <button
            ...
            className="flex items-center gap-1 px-2.5 py-1 text-xs font-medium text-[var(--accent-soft-text)] hover:text-[var(--accent-bright)] bg-[var(--accent-soft)] hover:bg-[var(--accent-soft)] border border-accent/30 rounded-lg transition-colors"
          >
