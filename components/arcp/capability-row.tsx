      ...
      >
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <button
            ...
            className="flex items-center gap-1 px-2.5 py-1 text-xs font-medium text-[var(--accent-text)] hover:text-[var(--accent-bright)] bg-[var(--accent)] hover:bg-[var(--accent)] border border-[var(--accent)] rounded-lg transition-colors"
          >
